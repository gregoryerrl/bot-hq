...
| `frontend/src/hooks/useDragResize.ts`, `frontend/src/hooks/useFocusTrap.ts`, `frontend/src/hooks/useEscapeKey.ts`, `frontend/src/hooks/useListEditor.ts`, `frontend/src/hooks/useServerDraft.ts`, `frontend/src/hooks/useNow.ts` | small hooks (`useNow`: a clock for deadlines nothing announces — the needs-you view's temporary-halt wake) | S |
