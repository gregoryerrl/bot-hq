...
| `frontend/src/lib/time.ts`, `frontend/src/lib/phase.ts`, `frontend/src/lib/diffGroups.ts`, `frontend/src/lib/cn.ts`, `frontend/src/lib/sessionId.ts` | time/phase/diff-grouping/clsx/short-session-id helpers | S |
