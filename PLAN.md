...
- A.2 `[P]` Distill **`general-rules.md`** from current `rulebook.md`, `glossary.md`, `roles.md`, `mcp-tool-manifest.md`, `agent-onboarding.md`. Universal rules only (commit style, no Co-Authored-By, security, the `ask_user_choice`/`mark_awaiting_user` MCP conventions). Slim and tight.
