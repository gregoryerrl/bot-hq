...
> recap here], waiting output from these command `<a command>…`. I run
> the commands on [the hosting console] and paste the output on the input box. That
