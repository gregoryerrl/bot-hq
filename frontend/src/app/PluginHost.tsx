        ...
        message={
          pendingSpawn && (
            <div className="text-left">
              ...
              <pre className="max-h-72 overflow-y-auto overflow-x-hidden whitespace-pre-wrap [overflow-wrap:anywhere] rounded bg-surface-container-high p-2 font-code-sm text-code-sm text-on-surface">
