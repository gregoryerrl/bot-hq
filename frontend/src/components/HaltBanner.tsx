...
export function isApproval(r: {
  ...
  // An agent's close card (0081): a gate — Approve closes the session,
  // Reject keeps it open — rendered in the gate slot like any approval.
  if (r.kind === "close") return true;
