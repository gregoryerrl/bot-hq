...
// R15 AGENT-AUTHORITY-MATRIX + R16 CROSS-RESTART-RESUME-OPERATIONAL
// deferred to W1 (bilateral content + halt-resume mechanics, separable
// from W0 quick-wins).
